...
export async function POST(
  ...
  // Create adjustment movements for each line with a discrepancy
  ...
  for (const line of stocktake.lines) {
      ...
      () =>
        prisma.stockMovement.create({
          data: {
            ...
            // Positive variance = stock in (to location)
            // Negative variance = stock out (from location)
    ...
    // Link movement to stocktake line
