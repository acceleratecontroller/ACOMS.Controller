...
export default function LocationsPage() {
  ...
  const fetchLocations = useCallback(async () => {
    setLoading(true);
    const res = await fetch("/api/materials/locations");
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const url = editingLocation ? `/api/materials/locations/${editingLocation.id}` : "/api/materials/locations";
  ...
  async function handleArchive() {
    ...
    await fetch(`/api/materials/locations/${archiveTarget.id}`, { method: "DELETE" });
