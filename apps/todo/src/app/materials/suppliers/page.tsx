    ...
    <div>
      ...
      <div className="flex items-center gap-4 mb-4">
        <input
          ...
          className="border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 text-sm w-full sm:w-64 dark:bg-gray-700 dark:text-gray-100"
        />
          ...
          <table className="w-full text-sm">
            <thead className="bg-gray-50 dark:bg-gray-700/50 border-b border-gray-200 dark:border-gray-700">
              <tr>
                ...
                <th className="text-left px-4 py-3 font-medium text-gray-700 dark:text-gray-300">Contact</th>
                <th className="text-left px-4 py-3 font-medium text-gray-700 dark:text-gray-300">Phone</th>
                ...
                <th className="text-right px-4 py-3 font-medium text-gray-700 dark:text-gray-300">Items</th>
                <th className="text-right px-4 py-3 font-medium text-gray-700 dark:text-gray-300">Actions</th>
              </tr>
            </thead>
            <tbody>
              {suppliers.map((s) => (
                <tr key={s.id} onClick={() => router.push(`/materials/suppliers/${s.id}`)} className="border-b border-gray-100 dark:border-gray-700 hover:bg-blue-50 dark:hover:bg-blue-900/20 cursor-pointer">
                  <td className="px-4 py-3">
                    <span className="text-blue-600 font-medium">
                      {s.name}
                    </span>
                  </td>
                  <td className="px-4 py-3 text-gray-500 dark:text-gray-400">{s.contactName || "—"}</td>
                  ...
                  <td className="px-4 py-3 text-right text-gray-500 dark:text-gray-400">{s._count.items}</td>
