  ...
  return (
    <>
      ...
      >
        ...
        <div className="text-xs text-gray-600 font-medium w-24 truncate">{ownerDisplay}</div>
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-1 text-xs mb-2">
          <div><span className="text-gray-400">Owner:</span> <span className="font-medium text-gray-700">{ownerDisplay}</span></div>
