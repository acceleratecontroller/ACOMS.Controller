...
export const STATUS_COLORS: Record<string, string> = {
  ...
  STUCK: "bg-red-100 dark:bg-red-900/40 text-red-700 dark:text-red-300",
  AWAITING_RESPONSE: "bg-yellow-100 dark:bg-yellow-900/40 text-yellow-700 dark:text-yellow-300",
...
export function assigneeName(emp: Assignee): string {
